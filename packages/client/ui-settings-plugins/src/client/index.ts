...
import { VisionProvidersCard } from './VisionProvidersCard.tsx'
import { VISION_NS, VisionProvidersController } from './vision-providers-card-controller.ts'
...
export function apply(ctx: ClientContext): void {
  ...
  const vision = new VisionProvidersController(ctx.settingsScope.bind({ namespace: VISION_NS }))
