 ...
 */
import { PokeballLogo } from '@deepseek-ai/dsh-client-ui-primitives'
...
export function TriggerContent({ wide, t }: TriggerContentProps) {
  return (
    <>
      {/* Pokémon theme: the settings trigger carries a Pokéball mark. */}
      {wide ? <PokeballLogo size={16} /> : <PokeballLogo size={18} />}
